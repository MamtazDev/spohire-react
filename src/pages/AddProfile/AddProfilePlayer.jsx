...
=======
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            ...
            role: "Player",
            sports: user?.sports,
            referral: user?._id, ...addPlayerInfo,
        };
    ...
    return (<>
        <section className="overflow-x-hidden">
            <div className="container-fluid">
                {step === 0 || step === 1 ? (<div className="row align-items-center">
                    <div className="col-lg-5 p-0">
                        <div className="addplayer_left_banner text-center">
                            <img className="img-fluid" src={loginBanner} alt=""/>
                        </div>
                    ...
                    <div className="col-lg-7 p-0">
                        {step === 0 && (<FirstStepPlayer
                            setStep={setStep}
                            addPlayerInfo={addPlayerInfo}
                            setAddPlayerInfo={setAddPlayerInfo}
                        />)}

                        {step === 1 && (<SecondStepPlayer
                            setStep={setStep}
                            addPlayerInfo={addPlayerInfo}
                            setAddPlayerInfo={setAddPlayerInfo}
                            experience={experience}
...
>>>>>>> 7ea2a85f9731e345daa56dd5c908b766d4d93686
            </div>
        </section>
    </>);
};
