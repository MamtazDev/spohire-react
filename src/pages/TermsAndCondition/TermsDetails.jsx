    ...
    return (
        <div>
            <div className='terms_condition_details'>
                ...
                <p style={{ marginTop: "40px", marginBottom: "72px" }}>Eget gravida orci congue quis etiam condimentum mattis. Nibh morbi aliquam et, lectus rhoncus. Nullam lacus, urna quis tempus varius. Amet, venenatis, scelerisque dignissim sed. Tellus fermentum.</p>
