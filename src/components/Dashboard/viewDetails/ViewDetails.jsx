            ...
            <div className="job_offer">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-8">
                        ...
                        <span className="d-block f_sfPro text_color_cb fs_28 mb-4">Basketball </span>
                        <div className="personalInfo">
                            <p className="f_sfPro text_color_36 fs_18">Personal Information</p>
                            ...
                            <div className="row mb_40">
                                <div className="col-12 col-md-4">
                                    <div className="d-flex flex-column align-items-start gap-3">
                                        ...
                                        <div>
                                            <span
                                                className="f_sfPro text_color_cb fs_15">Nationality-Passport</span>
                                ...
                                <div className="col-12 col-md-4">
                                    <div className="d-flex flex-column align-items-start gap-3">
                                        <div>
                                            <span className="f_sfPro text_color_cb fs_15">Date of Birth</span>
                                ...
                                <div className="col-12 col-md-4">
                                    <div className="d-flex flex-column align-items-start gap-3">
                                        ...
                                        <div>
                                            <span className="f_sfPro text_color_cb fs_15">Dominant Hand </span>
                            ...
                            <div>
                                <p className="f_sfPro text_color_cb fs_15 mb-2">
                                    Experience
                                </p>
                                <div className="d-flex flex-column flex-lg-row align-items-start gap-5">
                                    <div>
                                        <p className="f_sfPro text_color_36 fs_18">2003-2010 Cleveland Cavaliers
                                        </p>
                                        <p className="f_sfPro text_color_36 fs_18">2010–2014 Miami Heat </p>
                                        <p className="f_sfPro text_color_36 fs_18">2014–2018 Cleveland Cavaliers
                                        </p>
                                        <p className="f_sfPro text_color_36 fs_18">2018–present Los Angeles
                                            Lakers</p>
                                    </div>
            ...
            <div className="strAbout mb_60">
                <div className="row justify-content-center">
                    <div className="col-12 col-md-6 col-lg-4">
                        <p className="f_sfPro text_color_36 fs_18 mb-2">Strengths Advantages</p>
                        <p className="f_sfPro text_color_cb fs_16">
                            ...
                            <a href="#" className="f_sfPro fs_16" style={{ color: "#0177FB" }}> See More</a>
                        </p>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <div className="col-12 col-md-6 col-lg-4">
                        <p className="f_sfPro text_color_36 fs_18 mb-2">Expectations From a New Club</p>
                        <p className="f_sfPro text_color_cb fs_16">
