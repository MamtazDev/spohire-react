        ...
        <div className='job_offers_wrapper'>
            ...
            <div className="job_offers_topBtn d-flex align-items-center justify-content-between">
                <div className="job_offers_topBtn_left d-flex gap-4">
                    <button className='fs-6 fw-medium text_color_80'>
                        Hybrid
                    </button>
                    ...
                    <div className="job_offers_item_content d-flex justify-content-between align-items-center">
                        <div className="left d-flex gap-4">
                            ...
                            <div className="job_offer_item_content">
                                ...
                                <div className="job_offerItem_address d-flex align-items-center gap-4">
                                    <div className="job_offer_location d-flex align-items-center gap-2">
                        ...
                        <div className="right">
                            <img src={starIcon} style={{ cursor: 'pointer' }} alt='icon' />
                        </div>
